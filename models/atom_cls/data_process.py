...
def _unit_read_records():
    iter = tf.python_io.tf_record_iterator('/home/daiab/machine_disk/code/quantum/photon/ohlcvr_ratio_norm.records')
    print(next(iter))
...
if __name__ == '__main__':
    ...
    data_batch, label_batch = read_tf_records(
        '/home/daiab/machine_disk/code/quantum/photon/ohlcvr_ratio_norm.records', 10)
