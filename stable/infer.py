...
import numpy as np
from rnn.stable.config import *
from rnn.stable.model import get_model
from rnn.stable.data_process import _norm_max_min
...
# rqalpha run -s 2016-01-01 -e 2016-02-01 -f /home/daiab/machine_disk/code/Craft/rnn/stable/infer.py  --account stock 100000 -p -bm 000001.XSHE
